...
usePageMeta({
  title: 'Pendaftaran PPDB - Nusantara Global Academy',
  description:
    'Lengkapi formulir pendaftaran PPDB Nusantara Global Academy untuk tahun ajaran 2024/2025 dan mulai perjalanan pendidikan putra-putri Anda.'
})
      ...
      <div class="container mx-auto">
          ...
          <nav class="flex mb-6 text-sm text-slate-500 font-medium" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-2">
              <li class="inline-flex items-center">
                <RouterLink to="/" id="breadcrumb-home"
              ...
              <li>
                <div class="flex items-center gap-2">
                  <iconify-icon icon="lucide:chevron-right" class="text-slate-300 text-base"></iconify-icon>
        ...
        <form class="space-y-8" @submit.prevent="handleSubmit">
          ...
          <section class="bg-white rounded-3xl p-8 shadow-lg border border-slate-100">
            <h3 class="text-xl font-bold text-slate-900 mb-8 border-l-4 border-blue-800 pl-4">
            ...
            <div class="grid md:grid-cols-2 gap-6">
              <div class="space-y-2 lg:col-span-2">
                ...
                <input type="text" placeholder="Sesuai Akte Kelahiran" v-model="form.student.fullName"
              ...
              <div class="space-y-2">
                ...
                <input type="text" placeholder="Kota Kelahiran" v-model="form.student.birthPlace"
                  class="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 transition-all focus:border-blue-800"
                  required />
              </div>
              <div class="space-y-2">
                ...
                <input type="date" v-model="form.student.birthDate"
                  class="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 transition-all focus:border-blue-800"
                  required />
              </div>
              <div class="space-y-2">
                ...
                <select
                  class="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 transition-all focus:border-blue-800"
                  v-model="form.student.gender" required>
              ...
              <div class="space-y-2">
                ...
                <input type="text" placeholder="Nama Sekolah Sebelumnya" v-model="form.student.previousSchool"
                  class="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 transition-all focus:border-blue-800"
                  required />
              </div>
            </div>
          ...
          <section class="bg-white rounded-3xl p-8 shadow-lg border border-slate-100">
            ...
            <div class="grid md:grid-cols-2 gap-6">
              <div class="space-y-2">
                ...
                <input type="text" v-model="form.parent.fatherName"
                  class="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 transition-all focus:border-blue-800"
                  required />
              </div>
              <div class="space-y-2">
                ...
                <input type="text" v-model="form.parent.motherName"
                  class="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 transition-all focus:border-blue-800"
                  required />
              </div>
              <div class="space-y-2">
                ...
                <input type="tel" placeholder="0812xxxxxx" v-model="form.parent.phone"
                  class="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 transition-all focus:border-blue-800"
                  required />
              </div>
              <div class="space-y-2">
                ...
                <input type="email" placeholder="email@anda.com" v-model="form.parent.email"
                  class="w-full px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 transition-all focus:border-blue-800"
                  required />
              </div>
              <div class="space-y-2 lg:col-span-2">
                ...
                <textarea rows="3" placeholder="Nama jalan, nomor rumah, RT/RW, Kelurahan, Kecamatan"
              ...
              <div class="space-y-2">
                ...
                <div class="grid sm:grid-cols-3 gap-4">
                  <label
                    ...
                    <input type="radio" name="program" value="sains-teknologi" v-model="form.program.choice"
                      class="w-4 h-4 text-blue-800" required />
                  ...
                  <label
                    class="flex items-center gap-3 p-4 rounded-xl border border-slate-200 hover:border-blue-500 cursor-pointer bg-slate-50 group transition-all">
                    <input type="radio" name="program" value="seni-budaya" v-model="form.program.choice"
                  ...
                  <label
                    class="flex items-center gap-3 p-4 rounded-xl border border-slate-200 hover:border-blue-500 cursor-pointer bg-slate-50 group transition-all">
                    <input type="radio" name="program" value="olahraga-prestasi" v-model="form.program.choice"
                      class="w-4 h-4 text-blue-800" />
                    <span class="text-sm font-medium">
                      Olahraga Prestasi
                    </span>
              ...
              <div class="space-y-4">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                  <div
                    ...
                    <iconify-icon icon="lucide:upload-cloud" class="text-2xl text-slate-400"></iconify-icon>
          ...
          <!-- Submission -->
          <section class="bg-blue-900 rounded-3xl p-8 shadow-xl text-white">
            <div class="flex items-start gap-4 mb-8">
              <input type="checkbox" id="agreement"
                class="mt-1 w-5 h-5 rounded border-blue-400 text-blue-600 focus:ring-blue-500" v-model="form.agreement"
                required />
              <label for="agreement" class="text-sm text-blue-100 leading-relaxed">
